...
import com.dallonf.ktcause.serialization.LangTypeRustSerialization.serializeAnyInferredLangType
...
object LangErrorRustSerialization {
    ...
    fun serializeLangErrorValueUsedAsConstraint(errorLangType: ErrorLangType.ValueUsedAsConstraint): JsonElement {
        return buildJsonObject {
            put("type", serializeAnyInferredLangType(errorLangType.type))
        }
    }
        ...
        return buildJsonObject {
            ...
            errorLangType.types?.let { types ->
                put("types", JsonArray(types.map {
                    buildJsonObject {
                        put("type", serializeAnyInferredLangType(it.type))
