...
public class CauseParser extends Parser {
	...
	public static final int
		...
		OBJECT=33, OPTION=34, RETURN=35, RETURNS=36, SET=37, SIGNAL=38, VARIABLE=39, 
		WITH=40, PATH=41, IDENTIFIER=42;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'option'", "'return'", "'returns'", "'set'", "'signal'", "'variable'", 
			"'with'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"RETURN", "RETURNS", "SET", "SIGNAL", "VARIABLE", "WITH", "PATH", "IDENTIFIER"
		};
	}
	...
	public final FileContext file() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 303936045056L) != 0)) {
				{
				setState(110);
				declaration();
				setState(119);
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4878101058560L) != 0)) {
				{
				setState(624);
				statement();
				setState(633);
	...
	public final CallExpressionSuffixContext callExpressionSuffix() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4436721865728L) != 0)) {
				{
				setState(922);
				callParam();
				setState(926);
